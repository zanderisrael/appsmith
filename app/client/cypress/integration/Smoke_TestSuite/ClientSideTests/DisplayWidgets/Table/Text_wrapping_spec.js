...
describe("Table Widget text wrapping functionality", function() {
  ...
  it("should check that cell is not wrapped when cell wrapping is disabled", () => {
  ...
  it("should check that other cells in the row is not wrapped when one of the cell is wrapped", () => {
  ...
  it("should check that cell wrapping option is only available for plain text, number, date and URL", () => {
    cy.openPropertyPane("tablewidgetv2");
    cy.editColumn("email");
    [
      {
  ...
  it("should check that plain text, number, date and URL column is getting wrapped when cell wrapping is enabled", () => {
    cy.openPropertyPane("tablewidgetv2");
    cy.editColumn("id");
  ...
  it("should check that pageSize does not change when cell wrapping is enabled", () => {
    cy.openPropertyPane("tablewidgetv2");
    cy.editColumn("image");
